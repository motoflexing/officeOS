        ...
        <div className="min-w-0 flex-1">
          <div className="flex flex-col justify-between gap-2 sm:flex-row sm:items-start">
            ...
            <div className="flex flex-wrap gap-2 sm:justify-end">
              ...
              <span className="text-xs text-slate-500">{formatAnnouncementDate(createdAt)}</span>
            </div>
          </div>
...
const AnnouncementPill = ({ label }: { label: string }) => (
  <span className="rounded-full bg-accent-500/10 px-2.5 py-1 text-xs font-medium text-accent-200 ring-1 ring-accent-400/20">
    {label}
  </span>
);
